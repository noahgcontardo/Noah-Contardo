...
combined_string = str(decrypted_ascii)

ascii_values = [int(combined_string[i:i+3]) for i in range(0, len(combined_string), 3)]

plaintext = ''.join(chr(value) for value in ascii_values)

print("Reconstructed Plaintext:", plaintext)
