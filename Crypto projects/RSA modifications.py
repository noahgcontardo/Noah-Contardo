...
ciphertext = [((char ** e) % n) for char in ascii_values]

decrypted_ascii = [((char ** final_t) % n) for char in ciphertext]

plaintext = ''.join(chr(value) for value in decrypted_ascii)
